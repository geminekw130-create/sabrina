...
import 'package:passageiro/features/address/domain/repositories/address_repository_interface.dart';
import 'package:passageiro/features/address/domain/services/address_service.dart';
import 'package:passageiro/features/address/domain/services/address_service_interface.dart';
import 'package:passageiro/features/auth/domain/repositories/auth_repository_interface.dart';
import 'package:passageiro/features/auth/domain/services/auth_service.dart';
import 'package:passageiro/features/auth/domain/services/auth_service_interface.dart';
import 'package:passageiro/features/coupon/domain/repositories/coupon_repository_interface.dart';
import 'package:passageiro/features/coupon/domain/services/coupon_service.dart';
import 'package:passageiro/features/coupon/domain/services/coupon_service_interface.dart';
import 'package:passageiro/features/home/domain/repositories/category_repo.dart';
import 'package:passageiro/features/location/domain/repositories/location_repository.dart';
import 'package:passageiro/features/location/domain/repositories/location_repository_interface.dart';
import 'package:passageiro/features/location/domain/services/location_service.dart';
import 'package:passageiro/features/location/domain/services/location_service_interface.dart';
import 'package:passageiro/features/message/domain/repositories/message_repository.dart';
import 'package:passageiro/features/message/domain/repositories/message_repository_interface.dart';
import 'package:passageiro/features/message/domain/services/message_service.dart';
import 'package:passageiro/features/message/domain/services/message_service_interface.dart';
import 'package:passageiro/features/my_level/controller/level_controller.dart';
import 'package:passageiro/features/my_level/domain/repositories/level_repository.dart';
import 'package:passageiro/features/my_level/domain/repositories/level_repository_interface.dart';
import 'package:passageiro/features/my_level/domain/services/level_service.dart';
import 'package:passageiro/features/my_level/domain/services/level_service_interface.dart';
import 'package:passageiro/features/my_offer/controller/offer_controller.dart';
import 'package:passageiro/features/my_offer/domain/repositories/offer_repository.dart';
import 'package:passageiro/features/my_offer/domain/repositories/offer_repository_interface.dart';
import 'package:passageiro/features/my_offer/domain/services/offer_service.dart';
import 'package:passageiro/features/my_offer/domain/services/offer_service_interface.dart';
import 'package:passageiro/features/notification/controllers/notification_controller.dart';
import 'package:passageiro/features/notification/domain/repositories/notification_repository.dart';
import 'package:passageiro/features/notification/domain/repositories/notification_repository_interface.dart';
import 'package:passageiro/features/notification/domain/services/notification_service.dart';
import 'package:passageiro/features/notification/domain/services/notification_service_interface.dart';
import 'package:passageiro/features/onboard/controllers/on_board_page_controller.dart';
import 'package:passageiro/features/parcel/domain/repositories/parcel_repository.dart';
import 'package:passageiro/features/parcel/domain/repositories/parcel_repository_interface.dart';
import 'package:passageiro/features/parcel/domain/services/parcel_service.dart';
import 'package:passageiro/features/parcel/domain/services/parcel_service_interface.dart';
import 'package:passageiro/features/payment/controllers/payment_controller.dart';
import 'package:passageiro/features/payment/domain/repositories/payment_repository.dart';
import 'package:passageiro/features/payment/domain/repositories/payment_repository_interface.dart';
import 'package:passageiro/features/payment/domain/services/payment_service.dart';
import 'package:passageiro/features/payment/domain/services/payment_service_interface.dart';
import 'package:passageiro/features/profile/domain/repositories/profile_repository.dart';
import 'package:passageiro/features/profile/domain/repositories/profile_repository_interface.dart';
import 'package:passageiro/features/profile/domain/services/profile_service.dart';
import 'package:passageiro/features/profile/domain/services/profile_service_interface.dart';
import 'package:passageiro/features/refer_and_earn/controllers/refer_and_earn_controller.dart';
import 'package:passageiro/features/refer_and_earn/domain/repositories/refer_earn_repository.dart';
import 'package:passageiro/features/refer_and_earn/domain/repositories/refer_earn_repository_interface.dart';
import 'package:passageiro/features/refer_and_earn/domain/services/refer_earn_service.dart';
import 'package:passageiro/features/refer_and_earn/domain/services/refer_earn_service_interface.dart';
import 'package:passageiro/features/refund_request/controllers/refund_request_controller.dart';
import 'package:passageiro/features/refund_request/domain/repositories/refund_request_repository.dart';
import 'package:passageiro/features/refund_request/domain/repositories/refund_request_repository_interface.dart';
import 'package:passageiro/features/refund_request/domain/services/refund_request_service.dart';
import 'package:passageiro/features/refund_request/domain/services/refund_request_service_interface.dart';
import 'package:passageiro/features/ride/domain/repositories/ride_repository.dart';
import 'package:passageiro/features/ride/domain/repositories/ride_repository_interface.dart';
import 'package:passageiro/features/ride/domain/services/ride_service.dart';
import 'package:passageiro/features/ride/domain/services/ride_service_interface.dart';
import 'package:passageiro/features/safety_setup/controllers/safety_alert_controller.dart';
import 'package:passageiro/features/safety_setup/domain/repositories/safety_alert_repository.dart';
import 'package:passageiro/features/safety_setup/domain/repositories/safety_alert_repository_interface.dart';
import 'package:passageiro/features/safety_setup/domain/services/safety_alert_service.dart';
import 'package:passageiro/features/safety_setup/domain/services/safety_alert_service_interface.dart';
import 'package:passageiro/features/splash/domain/repositories/config_repository.dart';
import 'package:passageiro/features/splash/domain/repositories/config_repository_interface.dart';
import 'package:passageiro/features/splash/domain/services/config_service.dart';
import 'package:passageiro/features/splash/domain/services/config_service_interface.dart';
import 'package:passageiro/features/support/controllers/help_support_controller.dart';
import 'package:passageiro/features/trip/controllers/trip_controller.dart';
import 'package:passageiro/features/auth/controllers/auth_controller.dart';
import 'package:passageiro/features/coupon/controllers/coupon_controller.dart';
import 'package:passageiro/features/coupon/domain/repositories/coupon_repository.dart';
import 'package:passageiro/features/dashboard/controllers/bottom_menu_controller.dart';
import 'package:passageiro/features/address/controllers/address_controller.dart';
import 'package:passageiro/features/home/controllers/banner_controller.dart';
import 'package:passageiro/features/home/controllers/category_controller.dart';
import 'package:passageiro/features/address/domain/repositories/address_repository.dart';
import 'package:passageiro/features/home/domain/repositories/banner_repo.dart';
...
import 'package:passageiro/features/auth/domain/repositories/auth_repository.dart';
import 'package:passageiro/features/message/controllers/message_controller.dart';
import 'package:passageiro/features/parcel/controllers/parcel_controller.dart';
import 'package:passageiro/features/profile/controllers/profile_controller.dart';
...
import 'package:passageiro/features/trip/domain/repositories/trip_repository.dart';
import 'package:passageiro/features/trip/domain/repositories/trip_repository_interface.dart';
import 'package:passageiro/features/trip/domain/services/service.dart';
import 'package:passageiro/features/trip/domain/services/service_interface.dart';
import 'package:passageiro/features/wallet/controllers/wallet_controller.dart';
import 'package:passageiro/features/wallet/domain/repositories/wallet_repository.dart';
import 'package:passageiro/features/wallet/domain/repositories/wallet_repository_interface.dart';
import 'package:passageiro/features/wallet/domain/services/wallet_service.dart';
import 'package:passageiro/features/wallet/domain/services/wallet_service_interface.dart';
